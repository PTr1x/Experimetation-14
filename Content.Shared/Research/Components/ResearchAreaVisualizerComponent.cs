...
public sealed partial class ResearchAreaVisualizerComponent : Component
{
    ...
    /// <summary>
    /// Maximum points capacity to prevent overflow
    /// </summary>
    [DataField("maxPoints")]
    public int MaxPoints = int.MaxValue - 1000000; // Safe margin
    ...
    /// <summary>
    /// Randomized tech placements by tier - using HashSet to prevent duplicates
    /// </summary>
    [ViewVariables(VVAccess.ReadOnly)]
    public Dictionary<int, HashSet<string>> TechPlacementsByTier = new();
}
...
public sealed class ResearchAreaVisualizerBoundInterfaceState : BoundUserInterfaceState
{
    ...
    public ResearchAreaVisualizerBoundInterfaceState(
        ...
        int points,
        Dictionary<int, HashSet<string>> placements,
        ...
        string? diskName)
    {
        ...
        TechPlacements = placements.ToDictionary(
            kvp => kvp.Key,
