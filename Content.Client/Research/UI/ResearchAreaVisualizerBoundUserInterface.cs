...
/// Uses XAML-like structure with technology buttons
/// </summary>
public sealed class ResearchAreaVisualizerWindow : SS14Window
{
    ...
    public ResearchAreaVisualizerWindow(ResearchAreaVisualizerBoundUserInterface interface)
    {
        ...
        // Header with points and disk info
        ...
        // Technologies container - XAML-like structure with buttons
    ...
    private void UpdateTechnologiesDisplay(List<string> technologies)
    {
        ...
        foreach (var tech in technologies)
        {
            ...
            // Style the technology buttons
            techButton.AddStyleClass("TechButton");
            
            _technologiesContainer.AddChild(techButton);
        }
    }
}
